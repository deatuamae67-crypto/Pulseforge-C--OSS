...
public:
    ...
    // success the original destination and logical presentation are restored,
    // ready for readback or SDL_RenderPresent(). A false result means renderer
...
private:
    ...
    [[nodiscard]] bool restore_logical_presentation(std::string* error = nullptr);
    ...
    int previous_logical_width_{};
    int previous_logical_height_{};
    SDL_RendererLogicalPresentation previous_logical_mode_{
